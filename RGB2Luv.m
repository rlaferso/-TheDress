...
Yn = 1.0;
Lt = .008856;           %white point based on illum F7, obs CIE 1931
Up = 0.19784977571475;  %white point based on illum F7, obs CIE 1931
Vp = 0.46834507665248;  %white point based on illum F7, obs CIE 1931
imsiz = size(im);
im = permute(im,[3 1 2]);
